    ...
    if (isMobile) {
        return (
            <div className="flex flex-col gap-4 w-full px-4">
                 <BentoCard className="flex-col items-center text-center">
                ...
                <BentoCard className="flex-col justify-center items-center">
                ...
                <div className="grid grid-cols-3 gap-4">
                    <a href={certificatesLink} target="_blank" rel="noopener noreferrer" className="group">
                        <BentoCard className="h-full flex-col items-center justify-center text-center">
                     ...
                     <BentoCard className="flex-col items-center justify-center">
                    ...
                    <BentoCard className="flex-col items-center justify-center text-center">
...
export function GlassPanelLayout() {
  ...
  const renderMobileContent = () => {
    switch (activeView) {
      ...
      case 'Projects':
        return <ProjectsView onProjectHover={() => {}} />;
      case 'Personal':
        return (
            <div className="h-full flex flex-col gap-4 px-4 pt-4 text-white">
                ...
                <div className="flex flex-col">
                    <h3 className="text-xl font-bold text-left shrink-0 mb-2 px-4">Tools and Technologies</h3>
                     <div className="group relative w-full overflow-hidden [mask-image:linear-gradient(to_right,transparent_0,black_20px,black_calc(100%-20px),transparent_100%)]">
